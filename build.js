...
class Index {
    ...
    async buildPlatform() {
        ...
        builder.build({
            config: {
                ...
                copyright: 'Copyright © 2020-2024 EarthKingdoms',
                artifactName: "EarthKingdoms-Launcher-${os}-${arch}.${ext}",
            ...
            console.error('Erreur durant le build !', err)
        })
    }
    ...
    async iconSet(url) {
        ...
        if (Buffer.status == 200) {
            ...
            console.log('Nouvelle icone configurée')
        } else {
